...
public abstract class ESConnectionUtil {
    ...
    public static JestClient createSearchboxClient() {
        return createClient("SEARCHBOX_URL");
    }

    public static JestClient createBonsaiClient() {
        return createClient("BONSAI_URL");
    }
